...
echo "$($PSQL "select distinct(name) from teams full join games on teams.team_id = games.winner_id full join games as o on teams.team_id = o.opponent_id where (games.year = 2014 and games.round = 'Eighth-Final') or (o.year = 2014 and o.round = 'Eighth-Final') order by name")"
